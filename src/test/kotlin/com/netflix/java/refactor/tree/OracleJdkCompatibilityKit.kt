...
class OracleJdkAssignOpTest: JRAssignOpTest(oracleJdk)
class OracleJdkInstanceOfTest: JRInstanceOfTest(oracleJdk)
class OracleJdkNewArrayTest: JRNewArrayTest(oracleJdk)
class OracleJdkArrayAccessTest: JRArrayAccessTest(oracleJdk)
class OracleJdkLambdaTest: JRLambdaTest(oracleJdk)